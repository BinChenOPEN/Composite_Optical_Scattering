...
MATERIAL = 'TW'; % Choose between 'TW' (Transparent wood) and 'WFN' (Wood Fiber Network)
switch MATERIAL
    case 'TW'
...
Params.n_Matrix      = n_Matrix;
Params.n_Fiber       = n_Fiber;
Params.Haze_x        = Haze_x;
Params.Haze_z        = Haze_z;
% close all,
% Save the data
